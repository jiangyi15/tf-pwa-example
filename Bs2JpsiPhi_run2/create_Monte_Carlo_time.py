...
np.save(f"MC_time_tag_{file_suffix}.npy", tag)
np.save(f"MC_time_eta_{file_suffix}.npy", eta)

print("Saving other data...")
np.save(f"MC_time_weight_{file_suffix}.npy", sw_corrected)
np.save(f"MC_time_angles_{file_suffix}.npy", np.stack([np.arccos(helcosthetaL), np.arccos(helcosthetaK), helphi], axis=-1))
np.save(f"MC_time_t_smear_{file_suffix}.npy", time)
np.save(f"MC_time_trigger_{file_suffix}.npy", trigger)
np.save(f"MC_time_year_{file_suffix}.npy", year)
...
print(f"  Tagging: MC_time_tag_{file_suffix}.npy, MC_time_eta_{file_suffix}.npy")
print(f"  Other: MC_time_weight_{file_suffix}.npy, MC_time_angles_{file_suffix}.npy, MC_time_trigger_{file_suffix}.npy, MC_time_year_{file_suffix}.npy")
...
def plot_distributions():
    ...
    plt.tight_layout()
    plt.savefig(f'MC_time_distributions_{file_suffix}.png', dpi=150, bbox_inches='tight')
    plt.close()
    print(f"\nGenerated plot: MC_time_distributions_{file_suffix}.png")
