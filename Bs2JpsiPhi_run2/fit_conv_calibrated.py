...
2. No flavour tagging calibration 
...
def parse_args():
    ...
    parser.add_argument('--config', type=str, default='config_conv_calibrated.yml',
                        help='Configuration file (default: config_conv_calibrated.yml)')
    parser.add_argument('--output', type=str, default='final_params_conv_calibrated',
                        help='Output file prefix (default: final_params_conv_calibrated)')
    parser.add_argument('--batch', type=int, default=250000,
                        help='Batch size for fitting (default: 250000)')
    parser.add_argument('--log-file', type=str, default='fit_calibrated_log.txt',
                        help='Log file path (default: fit_calibrated_log.txt)')
...
def create_combined_config(base_config_path, years, trigger):
    ...
    mappings = {
        ...
        "phsp_angles_double.npy": f"phsp_angles_double_{suffix}.npy",
        "phsp_t_smear_double.npy": f"phsp_t_smear_double_{suffix}.npy",
        "phsp_t_resolution_double.npy": f"phsp_t_resolution_double_{suffix}.npy",
        "phsp_tag_double.npy": f"phsp_tag_double_{suffix}.npy",
        "phsp_eta_double.npy": f"phsp_eta_double_{suffix}.npy",
        "phsp_weight_cut_double.npy": f"phsp_weight_cut_double_{suffix}.npy",
        "phsp_trigger_double.npy": f"phsp_trigger_double_{suffix}.npy",
        "phsp_year_double.npy": f"phsp_year_double_{suffix}.npy",
    }
    
    for old_name, new_name in mappings.items():
        config_content = config_content.replace(old_name, new_name)
    
    temp_config_path = f"config_conv_calibrated_{suffix}.yml"
...
def main():
    ...
    output_file = f"{args.output}_calibrated_{file_suffix}.json"
    ...
    required_files = [
        ...
        f"phsp_angles_double_{file_suffix}.npy",
        f"phsp_t_smear_double_{file_suffix}.npy",
        f"phsp_t_resolution_double_{file_suffix}.npy",
        f"phsp_tag_double_{file_suffix}.npy",
        f"phsp_eta_double_{file_suffix}.npy",
        f"phsp_weight_cut_double_{file_suffix}.npy",
        "final_params_calibrated.json",
    ]
    ...
    config.set_params("final_params_calibrated.json")
    ...
    plot_dir = f"figure_conv_calibrated_{file_suffix}"
