...
def parse_args():
    ...
    parser.add_argument('--config', type=str, default='config_conv_Monte_Carlo_time.yml',
                        help='Configuration file (default: config_conv_Monte_Carlo_time.yml)')
    parser.add_argument('--output', type=str, default='final_params_conv_Monte_Carlo_time',
                        help='Output file prefix (default: final_params_conv_Monte_Carlo_time)')
    parser.add_argument('--batch', type=int, default=250000,
                        help='Batch size for fitting (default: 250000)')
    parser.add_argument('--log-file', type=str, default='fit_Monte_Carlo_time_log.txt',
                        help='Log file path (default: fit_Monte_Carlo_time_log.txt)')
...
def create_combined_config(base_config_path, years, trigger):
    ...
    mappings = {
        ...
        "MC_time_angles_double.npy": f"MC_time_angles_double_{suffix}.npy",
        "MC_time_t_smear_double.npy": f"MC_time_t_smear_double_{suffix}.npy",
        "MC_time_t_resolution_double.npy": f"MC_time_t_resolution_double_{suffix}.npy",
        "MC_time_tag_double.npy": f"MC_time_tag_double_{suffix}.npy",
        "MC_time_eta_double.npy": f"MC_time_eta_double_{suffix}.npy",
        "MC_time_weight_cut_double.npy": f"MC_time_weight_cut_double_{suffix}.npy",
        "MC_time_trigger_double.npy": f"MC_time_trigger_double_{suffix}.npy",
        "MC_time_year_double.npy": f"MC_time_year_double_{suffix}.npy",
    }
    
    for old_name, new_name in mappings.items():
        config_content = config_content.replace(old_name, new_name)
    
    temp_config_path = f"config_conv_Monte_Carlo_time_{suffix}.yml"
...
def main():
    ...
    output_file = f"{args.output}_Monte_Carlo_time_{file_suffix}.json"
    ...
    required_files = [
        ...
        f"MC_time_angles_double_{file_suffix}.npy",
        f"MC_time_t_smear_double_{file_suffix}.npy",
        f"MC_time_t_resolution_double_{file_suffix}.npy",
        f"MC_time_tag_double_{file_suffix}.npy",
        f"MC_time_eta_double_{file_suffix}.npy",
        f"MC_time_weight_cut_double_{file_suffix}.npy",
        "final_params_Monte_Carlo_time.json",
    ]
    ...
    config.set_params("final_params_Monte_Carlo_time.json")
    ...
    plot_dir = f"figure_conv_Monte_Carlo_time_{file_suffix}"
