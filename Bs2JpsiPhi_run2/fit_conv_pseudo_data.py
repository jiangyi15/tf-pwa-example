...
1. flavour_tag_mix model 
2. No flavour tagging correction 
3. Strict parameter validation
4. All parameters free 
...
def parse_args():
    ...
    parser.add_argument('--config', type=str, default='config_conv_pseudo_data.yml',
                        help='Configuration file (default: config_conv_pseudo_data.yml)')
    parser.add_argument('--output', type=str, default='final_params_conv_pseudo_data',
                        help='Output file prefix (default: final_params_conv_pseudo_data)')
    parser.add_argument('--batch', type=int, default=250000,
                        help='Batch size for fitting (default: 250000)')
    parser.add_argument('--log-file', type=str, default='fit_pseudo_data_log.txt',
                        help='Log file path (default: fit_pseudo_data_log.txt)')
...
def create_combined_config(base_config_path, years, trigger):
    ...
    mappings = {
        "pseudo_data_angles.npy": f"pseudo_data_angles_{suffix}.npy",
        "pseudo_data_t_smear.npy": f"pseudo_data_t_smear_{suffix}.npy",
        "pseudo_data_t_resolution.npy": f"pseudo_data_t_resolution_{suffix}.npy",
        "pseudo_data_tag.npy": f"pseudo_data_tag_{suffix}.npy",
        "pseudo_data_eta.npy": f"pseudo_data_eta_{suffix}.npy",
        "pseudo_data_weight.npy": f"pseudo_data_weight_{suffix}.npy",
        "pseudo_data_trigger.npy": f"pseudo_data_trigger_{suffix}.npy",
        "pseudo_data_year.npy": f"pseudo_data_year_{suffix}.npy",
        "pseudo_MC_angles_double.npy": f"pseudo_MC_angles_double_{suffix}.npy",
        "pseudo_MC_t_smear_double.npy": f"pseudo_MC_t_smear_double_{suffix}.npy",
        "pseudo_MC_t_resolution_double.npy": f"pseudo_MC_t_resolution_double_{suffix}.npy",
        "pseudo_MC_tag_double.npy": f"pseudo_MC_tag_double_{suffix}.npy",
        "pseudo_MC_eta_double.npy": f"pseudo_MC_eta_double_{suffix}.npy",
        "pseudo_MC_weight_cut_double.npy": f"pseudo_MC_weight_cut_double_{suffix}.npy",
        "pseudo_MC_trigger_double.npy": f"pseudo_MC_trigger_double_{suffix}.npy",
        "pseudo_MC_year_double.npy": f"pseudo_MC_year_double_{suffix}.npy",
    }
    
    for old_name, new_name in mappings.items():
        config_content = config_content.replace(old_name, new_name)
    
    temp_config_path = f"config_conv_pseudo_data_{suffix}.yml"
...
def main():
    ...
    required_files = [
        f"pseudo_data_angles_{file_suffix}.npy",
        f"pseudo_data_t_smear_{file_suffix}.npy",
        f"pseudo_data_t_resolution_{file_suffix}.npy",
        f"pseudo_data_tag_{file_suffix}.npy",
        f"pseudo_data_eta_{file_suffix}.npy",
        f"pseudo_data_weight_{file_suffix}.npy",
        f"pseudo_MC_angles_double_{file_suffix}.npy",
        f"pseudo_MC_t_smear_double_{file_suffix}.npy",
        f"pseudo_MC_t_resolution_double_{file_suffix}.npy",
