#!/usr/bin/env python3
"""Plot n_sigma and fitted-value histograms from phi_s_scan_results.txt.

Results file is tab-separated; per parameter there are 4 columns:
    <param>_value, <param>_error, <param>_reference, <param>_n_sigma

Outputs:
    phi_s_scan_nsigma_hist.png  -- n_sigma histograms (one per parameter)
    phi_s_scan_value_hist.png   -- fitted-value histograms with a red
...
OUT_NSIGMA = "phi_s_scan_nsigma_hist.png"
OUT_VALUE = "phi_s_scan_value_hist.png"
...
# Keep in sync with PARAMS/REFS + POLAR_PARAMS/POLAR_REFS in run_phi_s_scan.sh.
...
fig.suptitle(
    r"Distribution of $n_\sigma = |v - v_{\rm ref}| / \sigma$ over pseudo-experiments",
    y=1.00,
)
fig.tight_layout()
...
fig2.suptitle("Fitted value distributions over pseudo-experiments", y=1.00)
fig2.tight_layout()
